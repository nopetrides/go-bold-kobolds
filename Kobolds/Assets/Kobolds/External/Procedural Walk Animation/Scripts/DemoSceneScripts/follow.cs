			...
			switch (followPos)
			{
				case followposition.follow_X:
					transform.position = new Vector3(
						target.position.x + offset_X, transform.position.y, transform.position.z);
					break;

				case followposition.follow_y:
					transform.position = new Vector3(
						transform.position.x, target.position.y + offset_Y, transform.position.z);
					break;

				case followposition.follow_z:
					transform.position = new Vector3(
						transform.position.x, transform.position.y, target.position.z + offset_Z);
					break;

				case followposition.follow_xz:
					transform.position = new Vector3(
						target.position.x + offset_X, transform.position.y, target.position.z + offset_Z);
					break;
			...
			switch (copyRot)
			{
				case CopyRotation.rotation_X:
					transform.rotation = Quaternion.Euler(
						target.rotation.eulerAngles.x, transform.rotation.y, transform.rotation.z);
					break;

				case CopyRotation.rotation_y:
					transform.rotation = Quaternion.Euler(
						transform.rotation.x, target.rotation.eulerAngles.y, transform.rotation.z);
					break;

				case CopyRotation.rotation_z:
					transform.rotation = Quaternion.Euler(
						transform.rotation.x, transform.rotation.z, target.rotation.eulerAngles.z);
					break;
