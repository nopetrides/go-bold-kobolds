namespace ModelShark
{
	...
	{
		public bool IsAny => BottomLeftCorner || TopLeftCorner || TopRightCorner || BottomRightCorner;
		public bool TopEdge => TopLeftCorner && TopRightCorner;
		public bool RightEdge => TopRightCorner && BottomRightCorner;
		public bool LeftEdge => TopLeftCorner && BottomLeftCorner;
		public bool BottomEdge => BottomLeftCorner && BottomRightCorner;
		...
		/// <summary>
		///     Suggests a better tooltip position, based on where the tooltip is overflowing and the previously-desired
		///     position.
		/// </summary>
		...
		{
			var useMousePos = fromPosition == TipPosition.MouseBottomLeftCorner ||
							fromPosition == TipPosition.MouseTopLeftCorner ||
							fromPosition == TipPosition.MouseBottomRightCorner ||
							fromPosition == TipPosition.MouseTopRightCorner
							|| fromPosition == TipPosition.MouseTopMiddle ||
							fromPosition == TipPosition.MouseLeftMiddle ||
							fromPosition == TipPosition.MouseRightMiddle ||
							fromPosition == TipPosition.MouseBottomMiddle;
