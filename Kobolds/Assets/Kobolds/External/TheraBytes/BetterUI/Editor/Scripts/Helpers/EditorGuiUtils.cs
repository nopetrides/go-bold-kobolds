...
namespace TheraBytes.BetterUi.Editor
{
	public static class EditorGuiUtils
	{
		public const string ObsoleteMessage =
			"This method is obsolete.You most probably need to update the Better TextMesh Pro package. Please check the upgrade guide for more information: https://documentation.therabytes.de/better-ui/UpgradeGuide.html ";

		public static void DrawOldMethodCallWarning()
		{
			EditorGUILayout.HelpBox(
				@"Calling an old method. You probably need to update the Better TextMesh Pro package.
...
#region Backwards Compatibility Methods
		...
		public static void DrawLayoutList<T>(
			string listTitle,
		...
		[Obsolete(ObsoleteMessage)]
		public static void DrawLayoutList<T>(
			string listTitle, bool usingFoldout,
			List<T> list, SerializedProperty listProp, ref int count, ref bool foldout,
			Action<SerializedProperty> createCallback, Action<T, SerializedProperty> drawItemCallback)
		{
			DrawOldMethodCallWarning();
