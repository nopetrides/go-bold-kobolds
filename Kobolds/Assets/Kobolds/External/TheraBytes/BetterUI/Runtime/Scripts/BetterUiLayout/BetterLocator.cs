...
namespace TheraBytes.BetterUi
{
	...
	public class BetterLocator : MonoBehaviour, IResolutionDependency
	{
		...
		[SerializeField] private RectTransformData transformFallback;
		...
		{
			var isUnInitialized = transformFallback == null
			...
			if (isUnInitialized) InitTransformFallback();
		}
#endif

		private void InitTransformFallback()
		{
			if (transformFallback == null) transformFallback = new RectTransformData();
