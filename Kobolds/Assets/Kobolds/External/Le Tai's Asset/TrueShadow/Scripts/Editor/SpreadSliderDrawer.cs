...
namespace LeTai.TrueShadow.Editor
{
	...
	public class SpreadSliderDrawer : PropertyDrawer
	{
		...
		private const float MARKER_HEIGHT = 6;
		private const float MARKER_ALPHA = .75f;
		private const float MARKER_FILLET = 2;

		private static readonly Vector4 START_RADII = new(MARKER_FILLET, 0, 0, MARKER_FILLET);
		private static readonly Vector4 END_RADII = new(0, MARKER_FILLET, MARKER_FILLET, 0);
		...
		private void DrawMarkers(Rect sliderPosition, params (float, Color)[] markers)
		{
