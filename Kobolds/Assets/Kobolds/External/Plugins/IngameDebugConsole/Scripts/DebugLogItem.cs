...
#pragma warning restore 0649
		...
		public void SetContent(
			DebugLogEntry logEntry, DebugLogEntryTimestamp? logEntryTimestamp, int entryIndex, bool isExpanded)
		{
			this.Entry = logEntry;
			...
			if (isExpanded)
			{
				...
				if (!copyLogButton.gameObject.activeSelf)
				{
					...
					logText.rectTransform.anchoredPosition = new Vector2(
						logTextOriginalPosition.x, logTextOriginalPosition.y + copyLogButtonHeight * 0.5f);
