...
namespace Febucci.UI.Effects
{
	[Preserve]
	[CreateAssetMenu(
		fileName = "Horizontal Expand Appearance", menuName = "Text Animator/Animations/Appearances/Horizontal Expand")]
		...
		public override void ApplyEffectTo(ref CharacterData character, TAnimCore animator)
		{
			...
			switch (type)
			{
				...
				case ExpType.Left:
					...
					character.current.positions[2] = Vector3.LerpUnclamped(
						startTop, character.current.positions[2], pct);
					character.current.positions[3] = Vector3.LerpUnclamped(
						startBot, character.current.positions[3], pct);
					break;
				...
				case ExpType.Right:
					...
					character.current.positions[1] = Vector3.LerpUnclamped(
						startTop, character.current.positions[1], pct);
					character.current.positions[0] = Vector3.LerpUnclamped(
						startBot, character.current.positions[0], pct);
					break;
