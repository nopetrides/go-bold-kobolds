...
namespace Dreamteck.Splines
{
	...
	public struct SplinePoint
	{
		...
		{
			if (obj is SplinePoint) return EqualsFast((SplinePoint) obj);
			return false;
		}
		...
		{
			if (position.x != value) isDirty = true;
			position.x = value;
		}

		public void SetPositionY(float value)
		{
			if (position.y != value) isDirty = true;
			position.y = value;
		}

		public void SetPositionZ(float value)
		{
			if (position.z != value) isDirty = true;
			position.z = value;
		}

		public void SetTangentX(float value)
		{
			if (tangent.x != value) isDirty = true;
			tangent.x = value;
		}

		public void SetTangentY(float value)
		{
			if (tangent.y != value) isDirty = true;
			tangent.y = value;
		}

		public void SetTangentZ(float value)
		{
			if (tangent.z != value) isDirty = true;
			tangent.z = value;
		}

		public void SetTangent2X(float value)
		{
			if (tangent2.x != value) isDirty = true;
			tangent2.x = value;
		}

		public void SetTangent2Y(float value)
		{
			if (tangent2.y != value) isDirty = true;
			tangent2.y = value;
		}

		public void SetTangent2Z(float value)
		{
			if (tangent2.z != value) isDirty = true;
			tangent2.z = value;
		}

		public void SetNormalX(float value)
		{
			if (normal.x != value) isDirty = true;
			normal.x = value;
		}

		public void SetNormalY(float value)
		{
			if (normal.y != value) isDirty = true;
			normal.y = value;
		}

		public void SetNormalZ(float value)
		{
			if (normal.z != value) isDirty = true;
			normal.z = value;
		}

		public void SetColorR(float value)
		{
			if (color.r != value) isDirty = true;
			color.r = value;
		}

		public void SetColorG(float value)
		{
			if (color.g != value) isDirty = true;
			color.g = value;
		}

		public void SetColorB(float value)
		{
			if (color.b != value) isDirty = true;
			color.b = value;
		}

		public void SetColorA(float value)
		{
			if (color.a != value) isDirty = true;
			color.a = value;
		}
