...
namespace Dreamteck.Splines.Editor
{
	public struct SerializedSplinePoint
	{
		...
		{
			get => (SplinePoint.Type) _type.enumValueIndex;
			set
			{
				if (value != type)
				{
		...
		private readonly SerializedProperty _point;
		private readonly SerializedProperty _position;
		private readonly SerializedProperty _tangent;
		private readonly SerializedProperty _tangent2;
		private readonly SerializedProperty _normal;
		private readonly SerializedProperty _size;
		...
		private void CheckForChange(SplinePoint point)
		{
			...
			if (type != point.type) changed = true;
		}
