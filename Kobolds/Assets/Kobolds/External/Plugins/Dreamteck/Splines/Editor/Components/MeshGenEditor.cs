...
namespace Dreamteck.Splines.Editor
{
	...
	public class MeshGenEditor : SplineUserEditor
	{
		...
		protected override void BodyGUI()
		{
			...
			var meshIndexFormat = serializedObject.FindProperty("_meshIndexFormat");
			...
			if (_commonFoldout)
			{
				...
				EditorGUILayout.PropertyField(
					markDynamic,
					new GUIContent(
						"Mark Dynamic", "Improves performance in situations where the mesh changes frequently"));
				EditorGUILayout.PropertyField(
					meshIndexFormat,
					new GUIContent(
						"Index Format",
			...
			if (generator.GetComponent<MeshCollider>() != null)
			{
				...
				generator.colliderUpdateRate = EditorGUILayout.FloatField(
					"Collider Update Iterval", generator.colliderUpdateRate);
			}
