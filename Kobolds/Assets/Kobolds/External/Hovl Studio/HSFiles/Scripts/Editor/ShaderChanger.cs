...
namespace HovlStudio
{
	public class RPChanger : EditorWindow
	{
		...
		private static Shader Blend_CG_SG,
							LightGlow_SG,
							Lit_CenterGlow_SG,
							Blend_TwoSides_SG,
							Blend_Normals_SG,
		...
		private static Material[] shaderMaterials;
		...
		public void OnGUI()
		{
			...
			GUILayout.Label(
				"Don't forget to enable Depth and Opaque\ncheck-buttons in your URP asset seeting.",
		...
		{
			var checkAsset = AssetDatabase.FindAssets("HSstartupCheck");
		...
		{
			var window = (RPChanger) GetWindow(typeof(RPChanger));
		...
		private static void FindShaders()
		{
			if (Shader.Find("Hovl/Particles/Add_CenterGlow") != null)
				Add_CG = Shader.Find("Hovl/Particles/Add_CenterGlow");
			if (Shader.Find("Hovl/Particles/Blend_CenterGlow") != null)
				Blend_CG = Shader.Find("Hovl/Particles/Blend_CenterGlow");
			...
			if (Shader.Find("Hovl/Particles/Lit_CenterGlow") != null)
				Lit_CenterGlow = Shader.Find("Hovl/Particles/Lit_CenterGlow");
			if (Shader.Find("Hovl/Particles/Blend_TwoSides") != null)
				Blend_TwoSides = Shader.Find("Hovl/Particles/Blend_TwoSides");
			if (Shader.Find("Hovl/Particles/Blend_Normals") != null)
				Blend_Normals = Shader.Find("Hovl/Particles/Blend_Normals");
			...
			if (Shader.Find("Hovl/Particles/BlendDistort") != null)
				BlendDistort = Shader.Find("Hovl/Particles/BlendDistort");
			if (Shader.Find("Hovl/Particles/VolumeLaser") != null)
				VolumeLaser = Shader.Find("Hovl/Particles/VolumeLaser");
			...
			if (Shader.Find("Shader Graphs/HS_LightGlow") != null)
				LightGlow_SG = Shader.Find("Shader Graphs/HS_LightGlow");
			if (Shader.Find("Shader Graphs/HS_Lit_CenterGlow") != null)
				Lit_CenterGlow_SG = Shader.Find("Shader Graphs/HS_Lit_CenterGlow");
			if (Shader.Find("Shader Graphs/HS_Blend_TwoSides") != null)
				Blend_TwoSides_SG = Shader.Find("Shader Graphs/HS_Blend_TwoSides");
			if (Shader.Find("Shader Graphs/HS_Blend_Normals") != null)
				Blend_Normals_SG = Shader.Find("Shader Graphs/HS_Blend_Normals");
			...
			if (Shader.Find("Shader Graphs/HS_Distortion") != null)
				Distortion_SG = Shader.Find("Shader Graphs/HS_Distortion");
			if (Shader.Find("Shader Graphs/HS_ParallaxIce") != null)
				ParallaxIce_SG = Shader.Find("Shader Graphs/HS_ParallaxIce");
			if (Shader.Find("Shader Graphs/HS_Blend_CG") != null)
				Blend_CG_SG = Shader.Find("Shader Graphs/HS_Blend_CG");
			if (Shader.Find("Shader Graphs/HS_BlendDistort") != null)
				BlendDistort_SG = Shader.Find("Shader Graphs/HS_BlendDistort");
			if (Shader.Find("Shader Graphs/HS_VolumeLaser") != null)
				VolumeLaser_SG = Shader.Find("Shader Graphs/HS_VolumeLaser");
			if (Shader.Find("Shader Graphs/HS_Explosion") != null)
				Explosion_SG = Shader.Find("Shader Graphs/HS_Explosion");
			if (Shader.Find("Shader Graphs/HS_SwordSlash") != null)
				SwordSlash_SG = Shader.Find("Shader Graphs/HS_SwordSlash");
			if (Shader.Find("Shader Graphs/HS_ShockWave") != null)
				ShockWave_SG = Shader.Find("Shader Graphs/HS_ShockWave");
			if (Shader.Find("Shader Graphs/HS_SoftNoise") != null)
				SoftNoise_SG = Shader.Find("Shader Graphs/HS_SoftNoise");

			var folderMat = AssetDatabase.FindAssets("t:Material", new[] {"Assets"});
			shaderMaterials = new Material[folderMat.Length];

			for (var i = 0; i < folderMat.Length; i++)
			{
		...
		private static void ChangeToSG()
		{
			foreach (var material in shaderMaterials)
			{
				...
				{
					Debug.Log("First import shaders!");
				}
		...
		private static void ChangeToBiRP()
		{
			foreach (var material in shaderMaterials)
			{
				...
				if (Shader.Find("Hovl/Particles/Add_CenterGlow") != null)
					if (material.shader == Blend_CG_SG)
					{
						...
						{
							var blend = material.GetFloat("_Blend");
							if (blend == 2)
							{
						...
						{
							var blend = material.GetFloat("_BUILTIN_Blend");
							if (blend == 2)
							{
								material.shader = Add_CG;
								Debug.Log("Shaders changed successfully");
