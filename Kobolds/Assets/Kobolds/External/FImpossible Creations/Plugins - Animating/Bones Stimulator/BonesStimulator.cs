...
namespace FIMSpace.BonesStimulation
{
	...
	public partial class BonesStimulator : FimpossibleComponent
	{
		...
		[Tooltip(
			"If you want to smoothly disable bones stimulator when this object is far away from main camera object")]
		...
		/// <summary>
		///     Just StimulatorAmount value saved at component Start(). Can be helpful for value controlling scripts but
		///     consider using CustomBlendAmount variable instead.
		/// </summary>
