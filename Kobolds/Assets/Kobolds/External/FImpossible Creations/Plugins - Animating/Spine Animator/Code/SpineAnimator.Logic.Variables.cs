...
#region MAIN CALCULATIONS VARIABLES
		...
		/// <summary>
		///     Depends of bones' hierarchy structure, sometimes you will need leading bone in reversed position than
		///     default, this variable will help handling it in code
		/// </summary>
...
#region Extra helper variables
		...
		/// <summary>
		///     Variable to calculate difference in last frame position to current, needed for some straigtening calculations
		///     when bone is in move
		/// </summary>
