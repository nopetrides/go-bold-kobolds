...
namespace FIMSpace.FSpine
{
	public partial class FSpineAnimator
	{
		...
		public Transform FindBaseTransform()
		{
			...
			if (mySpine != null)
			{
				if (mySpine.BaseTransform != null) target = mySpine.BaseTransform;
				else target = mySpine.transform;
		...
		{
			if (SpineBones == null || SpineBones.Count == 0) return null;
			if (LastBoneLeading) return SpineBones[0];
		...
		{
			if (BaseTransform == null) return transform;
