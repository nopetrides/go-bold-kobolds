...
public partial class FSpineAnimator_Editor
{
    ...
    private void Tab_DrawTweaking()
    {
        ...
        else
        {
            ...
            if (EditorGUI.EndChangeCheck()) { serializedObject.ApplyModifiedProperties(); if ( Get.PivotOffsetOnStart == false) Get.UpdatePivotOffsetState(); }
        ...
        if (Application.isPlaying == false)
        {
            ...
            if (Get.PivotOffsetOnStart == false)
        ...
        GUILayout.Space(3f);
        SerializedProperty spc = sp_MainPivotOffset.Copy(); spc.Next(false);
