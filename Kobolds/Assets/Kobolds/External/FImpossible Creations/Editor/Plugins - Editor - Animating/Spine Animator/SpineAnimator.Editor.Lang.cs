...
public partial class FSpineAnimator_Editor
{
	...
	private TextAsset langFile
	{
		get
		{
			if (_langFile == null) _langFile = Resources.Load("Spine Animator/SpineAnimator_Langs") as TextAsset;
			return _langFile;
		}
	}
	...
	private void SetupLangs()
	{
		...
		if (langFile == null)
		{
			Debug.LogError("No lang file! You moved it from Editor/Resources/Spine Animator/ ???");
			return;
		}
