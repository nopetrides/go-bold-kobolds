...
namespace FIMSpace.Basics
{
	...
	public class FBasic_PowerUpObject : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			transform.position = initPosition + new Vector3(
				0f, Mathf.Sin((Time.time + randomOffset) * FloatingSpeedRate) * YFloatingValue, 0f);
		}
		...
		{
			if (other.transform.tag == TagToCollideWith) Collect();
		}
