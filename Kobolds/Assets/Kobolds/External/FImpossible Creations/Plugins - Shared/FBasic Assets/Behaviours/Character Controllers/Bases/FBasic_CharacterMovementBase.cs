...
namespace FIMSpace.Basics
{
	...
	///     Recommending to use rigidbody movement, because character controller's Move() method is expensive when it comes to
	///     use by about 50 objects
	/// </summary>
	...
	public abstract class FBasic_CharacterMovementBase : MonoBehaviour
	{
		...
		/// <summary>
		///     Setting flag to start jump for controller, used as a flag because jump calculations should be executed in different
		///     lines of code
		/// </summary>
