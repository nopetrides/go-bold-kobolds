...
namespace StarterAssets
{
	public partial class StarterAssetsDeployMenu : ScriptableObject
	{
		...
		private static void ResetThirdPersonControllerArmature()
		{
			...
			{
				if (TryLocatePrefab(
						PlayerArmaturePrefabName, null,
						new[] {typeof(ThirdPersonController), typeof(StarterAssetsInputs)}, out var prefab, out _))
		...
		{
			if (TryLocatePrefab(
					PlayerArmaturePrefabName, null, new[] {typeof(ThirdPersonController), typeof(StarterAssetsInputs)},
					out _, out var prefabPath))
			{
