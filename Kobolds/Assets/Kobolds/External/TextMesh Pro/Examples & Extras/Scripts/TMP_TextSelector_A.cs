	...
	public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
	{
		...
		private void LateUpdate()
		{
			...
			if (TMP_TextUtilities.IsIntersectingRectTransform(
					m_TextMeshPro.rectTransform, Input.mousePosition, Camera.main)) m_isHoveringObject = true;
...
#region Example of Link Handling
				...
				if (linkIndex != -1 && linkIndex != m_selectedLink)
				{
					...
					RectTransformUtility.ScreenPointToWorldPointInRectangle(
						m_TextMeshPro.rectTransform, Input.mousePosition, m_Camera, out worldPointInRectangle);
