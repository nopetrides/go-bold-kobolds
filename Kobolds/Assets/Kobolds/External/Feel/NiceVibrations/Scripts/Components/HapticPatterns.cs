	...
	public static class HapticPatterns
	{
		...
		static HapticPatterns()
		{
			...
			Selection = new Preset(
				PresetType.Selection, new[] {0.0f, 0.04f},
				new[] {0.471f, 0.471f});

			Light = new Preset(
				PresetType.LightImpact, new[] {0.000f, 0.040f},
				new[] {0.156f, 0.156f});

			Medium = new Preset(
				PresetType.MediumImpact, new[] {0.000f, 0.080f},
				new[] {0.471f, 0.471f});

			Heavy = new Preset(
				PresetType.HeavyImpact, new[] {0.0f, 0.16f},
				new[] {1.0f, 1.00f});

			Rigid = new Preset(
				PresetType.RigidImpact, new[] {0.0f, 0.04f},
				new[] {1.0f, 1.00f});

			Soft = new Preset(
				PresetType.SoftImpact, new[] {0.000f, 0.160f},
				new[] {0.156f, 0.156f});

			Success = new Preset(
				PresetType.Success, new[] {0.0f, 0.040f, 0.080f, 0.240f},
			...
			Warning = new Preset(
				PresetType.Warning, new[] {0.0f, 0.120f, 0.240f, 0.280f},
		...
		public static void PlayEmphasis(float amplitude, float frequency)
		{
			...
			if (HapticController.Init() || GamepadRumbler.IsConnected())
			{
				...
				rumble.durationsMs = new[] {(int) (duration * 1000)};
				rumble.lowFrequencyMotorSpeeds = new[] {clampedAmplitude};
				rumble.highFrequencyMotorSpeeds = new[] {clampedFrequency};
#endif
		...
		{
			if (amplitude > 0.5f) return PresetType.HeavyImpact;

			if (amplitude <= 0.5f && amplitude > 0.3) return PresetType.MediumImpact;
		...
		public static void PlayConstant(float amplitude, float frequency, float duration)
		{
			...
			for (var i = 0; i < rumbleEntryCount; i++)
			{
