...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	[FeedbackHelp(
		"This feedback allows you to control motion blur intensity over time. " +
		"It requires you have in your scene an object with a Volume " +
		"with MotionBlur active, and a MMMotionBlurShaker_HDRP component.")]
	public class MMF_MotionBlur_HDRP : MMF_Feedback
	{
		...
		[MMFInspectorGroup("Motion Blur", true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMMotionBlurShakeEvent_HDRP.Trigger(
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMMotionBlurShakeEvent_HDRP.Trigger(
				Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,
