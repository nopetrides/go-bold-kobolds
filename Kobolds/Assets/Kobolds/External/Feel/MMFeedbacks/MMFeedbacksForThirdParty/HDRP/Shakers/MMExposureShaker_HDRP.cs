...
{
	/// <summary>
	///     Add this class to a Camera with a HDRP exposure post processing and it'll be able to "shake" its values by getting
	///     events
	/// </summary>
#if MM_HDRP
 ...
 false, bool restore = false)
	...
	public struct MMExposureShakeEvent_HDRP
	{
		...
		public delegate void Delegate(
			AnimationCurve fixedExposure, float duration, float remapMin, float remapMax,
		...
		{
			OnEvent?.Invoke(
				fixedExposure, duration, remapMin, remapMax, relativeFixedExposure, attenuation, channelData,
