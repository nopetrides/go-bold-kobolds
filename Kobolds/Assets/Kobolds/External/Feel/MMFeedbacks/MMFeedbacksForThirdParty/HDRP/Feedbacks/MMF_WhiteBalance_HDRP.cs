...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	///     It requires you have in your scene an object with a Volume with White Balance active, and a
	///     MMWhiteBalanceShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp(
		"This feedback allows you to control white balance temperature and tint over time. " +
	...
	public class MMF_WhiteBalance_HDRP : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMWhiteBalanceShakeEvent_HDRP.Trigger(
				ShakeTemperature, FeedbackDuration, RemapTemperatureZero, RemapTemperatureOne,
