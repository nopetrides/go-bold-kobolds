...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMPaniniProjectionShaker_URP : MMShaker
	{
		...
		protected override void Shake()
		{
			var newValue = ShakeFloat(
				ShakeDistance, RemapDistanceZero, RemapDistanceOne, RelativeDistance, _initialDistance);
		...
		public virtual void OnPaniniProjectionShakeEvent(
			AnimationCurve distance, float duration, float remapMin, float remapMax, bool relativeDistance = false,
	...
	public struct MMPaniniProjectionShakeEvent_URP
	{
		...
		{
			OnEvent?.Invoke(
				distance, duration, remapMin, remapMax, relativeDistance, attenuation, channelData,
