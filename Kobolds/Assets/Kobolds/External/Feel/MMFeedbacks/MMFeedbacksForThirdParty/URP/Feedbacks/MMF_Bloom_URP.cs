...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	///     object with a Volume with Bloom active, and a MMBloomShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp(
	...
	public class MMF_Bloom_URP : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float attenuation = 1.0f)
		{
			...
			MMBloomShakeEvent_URP.Trigger(
				ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, ShakeThreshold,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMBloomShakeEvent_URP.Trigger(
				ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,
