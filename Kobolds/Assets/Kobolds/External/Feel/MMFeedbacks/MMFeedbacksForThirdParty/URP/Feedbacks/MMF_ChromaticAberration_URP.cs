...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMF_ChromaticAberration_URP : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMChromaticAberrationShakeEvent_URP.Trigger(
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMChromaticAberrationShakeEvent_URP.Trigger(
				Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity,
				channelData: ChannelData, stop: true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			MMChromaticAberrationShakeEvent_URP.Trigger(
				Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity,
				channelData: ChannelData, restore: true);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			MMURPHelpers.GetOrCreateVolume<ChromaticAberration, MMChromaticAberrationShaker_URP>(
				Owner, "Chromatic Aberration");
#endif
		}
