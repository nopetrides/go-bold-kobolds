...
{
	/// <summary>
	///     Add this class to a Camera with a URP chromatic aberration post processing and it'll be able to "shake" its values
	///     by getting events
	/// </summary>
#if MM_URP
	...
	public class MMChromaticAberrationShaker_URP : MMShaker
	{
		...
		public virtual void OnMMChromaticAberrationShakeEvent(
