...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMCinemachinePriorityListener : MonoBehaviour
	{
...
#elif MM_CINEMACHINE3
			var prioritySettings = _camera.Priority;
		...
		{
			StartCoroutine(
				OnMMCinemachinePriorityEventCo(
					channelData, forceMaxPriority, newPriority, forceTransition,
					blendDefinition, resetValuesAfterTransition, timescaleMode, restore));
		}

		protected virtual IEnumerator OnMMCinemachinePriorityEventCo(
			MMChannelData channelData, bool forceMaxPriority, int newPriority, bool forceTransition,
			CinemachineBlendDefinition blendDefinition, bool resetValuesAfterTransition, TimescaleModes timescaleMode,
			bool restore = false)
		{
	...
	public struct MMCinemachinePriorityEvent
	{
		...
		{
			OnEvent?.Invoke(
				channelData, forceMaxPriority, newPriority, forceTransition, blendDefinition,
