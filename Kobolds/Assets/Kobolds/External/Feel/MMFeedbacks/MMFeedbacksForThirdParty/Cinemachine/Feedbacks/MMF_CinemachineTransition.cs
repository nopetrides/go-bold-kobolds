...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	[FeedbackHelp(
		"This feedback will let you change the priorities of your cameras. It requires a bit of setup : " +
 ...
 = value; } }
		...
		{
			get => ApplyTimeMultiplier(BlendDefintion.Time);
 ...
 FindAutomatedTarget<CinemachineVirtualCamera>();
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (Mode == Modes.Event)
			{
				MMCinemachinePriorityEvent.Trigger(
					ChannelData, ForceMaxPriority, NewPriority, ForceTransition, _tempBlend, ResetValuesAfterTransition,
					ComputedTimescaleMode);
			}
			else
			{
				MMCinemachinePriorityEvent.Trigger(
					ChannelData, ForceMaxPriority, 0, ForceTransition, _tempBlend, ResetValuesAfterTransition,
					ComputedTimescaleMode);
...
#elif MM_CINEMACHINE3
			var prioritySettings = TargetCinemachineCamera.Priority;
