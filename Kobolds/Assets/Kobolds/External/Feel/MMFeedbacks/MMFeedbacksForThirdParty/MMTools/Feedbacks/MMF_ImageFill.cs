...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_ImageFill : MMF_Feedback
	{
		...
		public MMTweenType Curve = new(
			MMTween.MMTweenCurve.EaseInCubic, "", "Mode", (int) Modes.OverTime, (int) Modes.ToDestination);
		...
		[MMFInspectorGroup("Image Fill Animation", true)]
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			{
				Debug.LogWarning(
					"[Image Fill Feedback] The image fill feedback on " + Owner.name +
					" doesn't have a bound image, it won't work. You need to specify an image in its inspector.");
				return;
			}

			if (Active) _initialInstantFill = BoundImage.fillAmount;
		}
		...
		{
			if (!Active || !FeedbackTypeAuthorized || BoundImage == null) return;
