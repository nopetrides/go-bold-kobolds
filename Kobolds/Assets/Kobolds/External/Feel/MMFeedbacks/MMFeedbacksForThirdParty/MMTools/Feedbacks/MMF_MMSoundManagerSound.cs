	...
	public class MMF_MMSoundManagerSound : MMF_Feedback
	{
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			if (RandomUnique)
			{
				...
				for (var i = 0; i < RandomSfx.Length; i++) _randomUniqueShuffleBag.Add(i, 1);
			}
		}
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (Sfx != null) PlaySound(Sfx, position, intensityMultiplier);
		}
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			if (StopSoundOnFeedbackStop && _playedAudioSource != null)
			{
				...
				if (RecycleAudioSource == null) MMSoundManager.Instance.FreeSound(_playedAudioSource);
			}
		}
		...
		{
			if (SoundDataSO != null) return ComputeDuration(SoundDataSO.Sfx, SoundDataSO.RandomSfx);
		...
		public override bool EvaluateRequiresSetup()
		{
			...
			if (SoundDataSO != null) requiresSetup = false;
...
#region TestMethods
		...
		protected virtual async void TestPlaySound()
		{
			...
			PlayAudioSource(
				_editorAudioSource, tmpAudioClip, volume, pitch, _randomPlaybackTime, _randomPlaybackDuration);
			_lastPlayTimestamp = FeedbackTime;
			_lastPlayedClip = tmpAudioClip;
			var length = _randomPlaybackDuration > 0 ? _randomPlaybackDuration : tmpAudioClip.length;
			length *= 1000;
		...
		protected virtual void PlayAudioSource(
			AudioSource audioSource, AudioClip sfx, float volume, float pitch, float time, float playbackDuration)
		{
		...
		public override void OnValidate()
		{
			...
			if (string.IsNullOrEmpty(FadeTween.ConditionPropertyName)) FadeTween.ConditionPropertyName = "Fade";
		}
