...
namespace MoreMountains.Tools
{
	...
	public struct MMPostProcessingMovingFilterEvent
	{
		...
		public delegate void Delegate(
			MMTweenType curve, bool active, bool toggle, float duration, int channel = 0,
	...
	public class MMPostProcessingMovingFilter : MonoBehaviour
	{
		...
		protected virtual void Initialization()
		{
			...
			_positionToRestore = transform.localPosition;
		...
		{
			transform.localPosition = _positionToRestore;
		}
		...
		public virtual void OnMMPostProcessingMovingFilterEvent(
			MMTweenType curve, bool active, bool toggle,
		...
		{
			MMPostProcessingMovingFilterEvent.Trigger(
				new MMTweenType(MMTween.MMTweenCurve.EaseInOutCubic), false, true,
				TestDuration);
		}
		...
		{
			MMPostProcessingMovingFilterEvent.Trigger(
				new MMTweenType(MMTween.MMTweenCurve.EaseInOutCubic), false,
				false, TestDuration);
		}
		...
		{
			MMPostProcessingMovingFilterEvent.Trigger(
				new MMTweenType(MMTween.MMTweenCurve.EaseInOutCubic), true, false,
				TestDuration);
		}
	}
}
