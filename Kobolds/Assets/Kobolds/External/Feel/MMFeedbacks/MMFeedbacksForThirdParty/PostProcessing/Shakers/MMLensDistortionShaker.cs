...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMLensDistortionShaker : MMShaker
	{
		...
		public AnimationCurve ShakeIntensity = new(
			new Keyframe(0, 0),
			new Keyframe(0.2f, 1),
		...
		public virtual void OnMMLensDistortionShakeEvent(
	...
	public struct MMLensDistortionShakeEvent
	{
		...
		{
			OnEvent?.Invoke(
				intensity, duration, remapMin, remapMax, relativeIntensity, feedbacksIntensity, channelData,
