...
{
	/// <summary>
	///     Add this debug component to a MMF Player, and you'll be able to play it at runtime at the press of a (customisable)
	///     key, useful when tweaking or debugging your feedbacks
	/// </summary>
	public class MMF_PlayerDebugInput : MonoBehaviour
	{
		...
		{
			_player = gameObject.GetComponent<MMF_Player>();
		}
		...
		protected virtual void Update()
		{
			...
			if (keyPressed) _player.PlayFeedbacks();
		}
	}
}
