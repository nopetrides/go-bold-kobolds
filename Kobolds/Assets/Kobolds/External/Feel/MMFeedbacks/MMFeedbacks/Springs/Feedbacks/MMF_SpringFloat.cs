...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_SpringFloat : MMF_Feedback
	{
		...
		[MMEnumCondition(
			"Command", (int) SpringCommands.MoveTo, (int) SpringCommands.MoveToAdditive,
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMSpringFloatEvent.Trigger(
				Command, TargetSpring, _eventChannelData, MoveToValue, BumpAmount, MoveToRandomValue,
				BumpAmountRandomValue, OverrideDamping, NewDamping, OverrideFrequency, NewFrequency);
		}
