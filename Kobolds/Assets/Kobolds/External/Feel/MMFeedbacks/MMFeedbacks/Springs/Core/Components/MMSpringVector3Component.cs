...
#region EVENTS
		...
		public void OnMMEvent(MMSpringVector3Event springEvent)
		{
			...
			if (springEvent.OverrideDamping) SpringVector3.SetDamping(springEvent.NewDamping);
			if (springEvent.OverrideFrequency) SpringVector3.SetFrequency(springEvent.NewFrequency);
