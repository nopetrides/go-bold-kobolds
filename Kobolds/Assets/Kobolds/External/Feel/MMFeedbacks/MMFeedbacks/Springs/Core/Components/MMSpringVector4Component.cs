...
#region EVENTS
		...
		public void OnMMEvent(MMSpringVector4Event springEvent)
		{
			...
			if (springEvent.OverrideDamping) SpringVector4.SetDamping(springEvent.NewDamping);
			if (springEvent.OverrideFrequency) SpringVector4.SetFrequency(springEvent.NewFrequency);
