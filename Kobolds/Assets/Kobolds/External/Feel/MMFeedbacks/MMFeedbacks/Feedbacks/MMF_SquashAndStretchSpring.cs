...
{
	/// <summary>
	///     This feedback will let you animate the scale of the target object over time, with a spring + squash and stretch
	///     effect
	/// </summary>
	[AddComponentMenu("")]
	...
	public class MMF_SquashAndStretchSpring : MMF_Feedback
	{
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			if (Active && AnimateScaleTarget != null) GetInitialValues();
		}
