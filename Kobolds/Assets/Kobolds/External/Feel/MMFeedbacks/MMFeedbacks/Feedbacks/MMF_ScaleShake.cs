...
namespace MoreMountains.Feedbacks
{
	...
	///     Scale shakers, as the name suggests, are used to shake the scale of a transform, along a direction, with optional
	///     noise and other fine control options.
	/// </summary>
	[AddComponentMenu("")]
	...
	public class MMF_ScaleShake : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (TargetShaker == null)
				...
				TargetShaker?.OnMMScaleShakeEvent(
					Duration, ShakeSpeed, ShakeRange, ShakeMainDirection, RandomizeDirection, ShakeAltDirection,
					RandomizeDirectionOnPlay, AddDirectionalNoise,
					DirectionalNoiseStrengthMin, DirectionalNoiseStrengthMax, RandomnessSeed, RandomizeSeedOnShake,
					UseAttenuation, AttenuationCurve,
