...
{
	/// <summary>
	///     This feedback lets you emit a RotationShake event. This will be caught by MMRotationShakers (on the specified
	///     channel).
	///     Rotation shakers, as the name suggests, are used to shake the rotation of a transform, along a direction, with
	///     optional noise and other fine control options.
	/// </summary>
	[AddComponentMenu("")]
