...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_TextureOffset : MMF_Feedback
	{
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			{
				Debug.LogWarning(
					"[Texture Offset Feedback] The texture offset feedback on " + Owner.name +
					" doesn't have a target renderer, it won't work. You need to specify a renderer in its inspector.");
				return;
			}
