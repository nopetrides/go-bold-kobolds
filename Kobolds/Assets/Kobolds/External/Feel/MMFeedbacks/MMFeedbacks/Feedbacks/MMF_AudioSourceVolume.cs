...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_AudioSourceVolume : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMAudioSourceVolumeShakeEvent.Trigger(
				VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, RelativeVolume,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMAudioSourceVolumeShakeEvent.Trigger(
				VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, stop: true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			if (!Active || !FeedbackTypeAuthorized) return;
			MMAudioSourceVolumeShakeEvent.Trigger(
				VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, restore: true);
		}
