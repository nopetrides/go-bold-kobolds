...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_CameraShake : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMCameraShakeEvent.Trigger(
				FeedbackDuration, CameraShakeProperties.Amplitude * intensityMultiplier,
 ...
 (CinemachineVirtualCamera)Object.FindObjectOfType(typeof(CinemachineVirtualCamera));
			...
			var camShaker = (MMCameraShaker) Object.FindAnyObjectByType(typeof(MMCameraShaker));
			...
			var cameraShaker = new GameObject("CameraShaker");
			...
			var wiggle = cameraShaker.GetComponent<MMWiggle>();
