...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_CameraOrthographicSize : MMF_Feedback
	{
		...
		public AnimationCurve ShakeOrthographicSize = new(
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MMCameraOrthographicSizeShakeEvent.Trigger(
				ShakeOrthographicSize, FeedbackDuration, RemapOrthographicSizeZero, RemapOrthographicSizeOne,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMCameraOrthographicSizeShakeEvent.Trigger(
				ShakeOrthographicSize, FeedbackDuration,
 ...
 (CinemachineVirtualCamera)Object.FindObjectOfType(typeof(CinemachineVirtualCamera));
			...
			var orthographicSizeShaker =
				(MMCameraOrthographicSizeShaker) Object.FindAnyObjectByType(typeof(MMCameraOrthographicSizeShaker));
			if (orthographicSizeShaker != null) return;
