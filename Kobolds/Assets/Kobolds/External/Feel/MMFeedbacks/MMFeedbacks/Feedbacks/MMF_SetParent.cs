...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_SetParent : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				Debug.LogWarning(
					"[SetParent Feedback] The set parent feedback on " + Owner.name +
					" doesn't have an ObjectToParent, it won't work. You need to specify one in its inspector.");
				return;
			}
		...
		public override string RequiresSetupText =>
			"This feedback requires an ObjectToParent, that will be reparented to NewParent";
#endif
	}
}
