	...
	public class MMF_Flash : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (TargetFlash != null)
				...
				MMFlashEvent.Trigger(
					FlashColor, FeedbackDuration * intensityMultiplier, FlashAlpha, FlashID, ChannelData,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MMFlashEvent.Trigger(
				FlashColor, FeedbackDuration, FlashAlpha, FlashID, ChannelData, ComputedTimescaleMode, true);
		}
		...
		{
			if (Object.FindAnyObjectByType<MMFlash>() != null) return;

			var (canvas, createdNewCanvas) = Owner.gameObject.MMFindOrCreateObjectOfType<Canvas>("FlashCanvas", null);
			canvas.renderMode = RenderMode.ScreenSpaceOverlay;
			var (image, createdNewImage) =
