...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_Looper : MMF_Pause
	{
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			if (OnLoop == null) OnLoop = new UnityEvent();
		}
		...
		public virtual void TriggerOnLoop(MMFeedbacks source)
		{
			...
			if (TriggerMMFeedbacksEvents) MMFeedbacksEvent.Trigger(source, MMFeedbacksEvent.EventTypes.Loop);
		}
		...
		public override Color DisplayColor => MMFeedbacksInspectorColors.LooperColor.MMDarken(0.25f);
#endif
	}
}
