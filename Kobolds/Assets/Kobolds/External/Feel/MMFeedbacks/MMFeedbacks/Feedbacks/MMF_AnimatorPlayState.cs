...
namespace MoreMountains.Feedbacks
{
	...
	[AddComponentMenu("")]
	[FeedbackHelp(
		"This feedback will allow you to play the specified state on the target Animator, either in normalized or fixed time.")]
	...
	public class MMF_AnimatorPlayState : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				Debug.LogWarning(
					"[Animator Play State Feedback] The animator play state feedback on " + Owner.name +
			...
			foreach (var animator in ExtraBoundAnimators) PlayState(animator, intensityMultiplier);
		}
