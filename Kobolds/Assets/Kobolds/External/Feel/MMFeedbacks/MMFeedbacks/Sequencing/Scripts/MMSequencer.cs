...
namespace MoreMountains.Feedbacks
{
	...
	public class MMSequencer : MonoBehaviour
	{
		...
		public virtual void ClearSequence()
		{
			...
			{
				for (var i = 0; i < SequencerLength; i++) Sequence.QuantizedSequence[trackIndex].Line[i].ID = -1;
			}
		}
		...
		protected virtual void HandleBeat()
		{
			...
			if (InternalTime - LastBeatTimestamp >= _beatInterval || LastBeatTimestamp == 0f) PlayBeat();
		}
