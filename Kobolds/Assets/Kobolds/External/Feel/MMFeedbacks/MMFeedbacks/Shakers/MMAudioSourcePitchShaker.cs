...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioSourcePitchShaker : MMShaker
	{
		...
		public virtual void OnMMAudioSourcePitchShakeEvent(
			AnimationCurve pitchCurve, float duration, float remapMin, float remapMax, bool relativePitch = false,
	...
	public struct MMAudioSourcePitchShakeEvent
	{
		...
		{
			OnEvent?.Invoke(
				pitchCurve, duration, remapMin, remapMax, relativePitch,
