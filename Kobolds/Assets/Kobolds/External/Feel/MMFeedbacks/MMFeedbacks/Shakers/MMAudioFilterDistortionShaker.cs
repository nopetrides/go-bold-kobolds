...
namespace MoreMountains.Feedbacks
{
	...
	public class MMAudioFilterDistortionShaker : MMShaker
	{
		...
		{
			var newDistortionLevel = ShakeFloat(
				ShakeDistortion, RemapDistortionZero, RemapDistortionOne, RelativeDistortion, _initialDistortion);
	...
	public struct MMAudioFilterDistortionShakeEvent
	{
		...
		{
			OnEvent?.Invoke(
				distortionCurve, duration, remapMin, remapMax, relativeDistortion,
