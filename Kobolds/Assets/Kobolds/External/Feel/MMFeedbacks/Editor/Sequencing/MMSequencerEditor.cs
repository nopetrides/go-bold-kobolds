	...
	public class MMSequencerEditor : Editor
	{
		...
		protected virtual void DrawSequenceIndexes()
		{
			...
			for (var i = 0; i < _targetSequencer.SequencerLength; i++)
			{
				...
				if (GUILayout.Button(
						label, _indexStyle, GUILayout.Width(_buttonWidth + _distanceBetweenButtons),
						GUILayout.Height(_trackControlWidth)))
				{
		...
		protected virtual void DrawTrack(int trackIndex)
		{
			...
			if (GUILayout.Button(
					"", _trackControlStyle, GUILayout.Width(_trackControlWidth), GUILayout.Height(_trackControlWidth)))
			...
			if (GUILayout.Button(
					trackIndex.ToString(), _trackControlStyle, GUILayout.Width(_trackControlWidth),
					GUILayout.Height(_trackControlWidth)))
				if (_targetSequencer.TrackEvents[trackIndex] != null)
				{
