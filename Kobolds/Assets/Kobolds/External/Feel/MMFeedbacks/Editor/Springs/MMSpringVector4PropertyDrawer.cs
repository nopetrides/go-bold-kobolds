...
namespace MoreMountains.Feedbacks
{
	...
	internal class MMSpringVector4PropertyDrawer : PropertyDrawer
	{
		...
		public override VisualElement CreatePropertyGUI(SerializedProperty property)
		{
			...
			var _separateAxis = property.FindPropertyRelative("SeparateAxis");
			var _unifiedSpring = property.FindPropertyRelative("UnifiedSpring");
			var _springX = property.FindPropertyRelative("SpringX");
			var _springY = property.FindPropertyRelative("SpringY");
			var _springZ = property.FindPropertyRelative("SpringZ");
			var _springW = property.FindPropertyRelative("SpringW");

			var boolToggle = new Toggle("SeparateAxis")
