...
namespace MoreMountains.Tools
{
	...
	public class MMPath : MonoBehaviour
	{
		...
		protected virtual void OnDrawGizmos()
		{
			...
			for (var i = 0; i < PathElements.Count; i++)
			{
				...
				MMDebug.DrawGizmoPoint(
					_originalTransformPosition + PathElements[i].PathElementPosition, 0.2f, Color.green);
				...
				if (i == PathElements.Count - 1 && CycleOption == CycleOptions.Loop)
				{
					Gizmos.color = Color.white;
					Gizmos.DrawLine(
						_originalTransformPosition + PathElements[0].PathElementPosition,
						_originalTransformPosition + PathElements[i].PathElementPosition);
				}
			}
		...
		public virtual void Initialization()
		{
			...
			{
				var path0Position = PathElements[0].PathElementPosition;
				transform.position += path0Position;

				foreach (var element in PathElements) element.PathElementPosition -= path0Position;
			}
