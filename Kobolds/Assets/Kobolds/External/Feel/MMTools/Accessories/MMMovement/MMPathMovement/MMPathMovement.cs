			...
			switch (AccelerationType)
			{
				case PossibleAccelerationType.ConstantSpeed:
					transform.position = Vector3.MoveTowards(
						transform.position, PointPosition(_currentPoint.Current), Time.deltaTime * MovementSpeed);
					break;
		...
		public virtual Vector3 PointPosition(Vector3 relativePointPosition)
		{
			switch (AlignmentMode)
			{
				...
				case AlignmentModes.ThisRotation:
					return _originalTransformPosition + transform.rotation * relativePointPosition;
				case AlignmentModes.ParentRotation:
					return _originalTransformPosition + transform.parent.rotation * relativePointPosition;
			}
