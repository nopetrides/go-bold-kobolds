	...
	public static class MMAchievementManager
	{
		...
		public static void LoadSavedAchievements()
		{
			...
			var serializedMMAchievementManager = (SerializedMMAchievementManager) MMSaveLoadManager.Load(
				typeof(SerializedMMAchievementManager), SaveFileName + _saveFileExtension, _saveFolderName);
		...
		{
			var tempFileName = !string.IsNullOrEmpty(ListID) ? ListID : _defaultFileName;
		...
		public static void FillSerializedMMAchievementManager(SerializedMMAchievementManager serializedAchievements)
		{
			...
			{
				var newAchievement = new SerializedMMAchievement(
					AchievementsList[i].AchievementID, AchievementsList[i].UnlockedStatus,
					AchievementsList[i].ProgressCurrent);
