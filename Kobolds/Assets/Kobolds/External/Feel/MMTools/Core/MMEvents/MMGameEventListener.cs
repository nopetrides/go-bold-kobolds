...
{
	/// <summary>
	///     Add this component to an object, and it'll let you easily trigger UnityEvents when the event of the specified name
	///     is triggered
	/// </summary>
	public class MMGameEventListener : MonoBehaviour, MMEventListener<MMGameEvent>
	{
		...
		{
			if (gameEvent.EventName == EventName) OnMMGameEvent?.Invoke();
		}
	}
}
