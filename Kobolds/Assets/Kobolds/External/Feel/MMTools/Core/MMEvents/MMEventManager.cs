...
namespace MoreMountains.Tools
{
	...
	public struct MMGameEvent
	{
		...
		public static void Trigger(
			string eventName, int intParameter = 0, Vector2 vector2Parameter = default,
			Vector3 vector3Parameter = default, bool boolParameter = false, string stringParameter = "")
		{
	...
	public static class MMEventManager
	{
		...
		public static void AddListener<MMEvent>(MMEventListener<MMEvent> listener) where MMEvent : struct
		{
			...
			if (!_subscribersList.ContainsKey(eventType)) _subscribersList[eventType] = new List<MMEventListenerBase>();
		...
		public static void TriggerEvent<MMEvent>(MMEvent newEvent) where MMEvent : struct
		{
			...
			for (var i = list.Count - 1; i >= 0; i--) (list[i] as MMEventListener<MMEvent>).OnMMEvent(newEvent);
		}
