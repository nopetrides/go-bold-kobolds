...
namespace MoreMountains.Tools
{
	...
	public class MMSimpleObjectPooler : MMObjectPooler
	{
		...
		public override void FillObjectPool()
		{
			...
			if (_objectPool != null) objectsToSpawn -= _objectPool.PooledGameObjects.Count;
		...
		public override GameObject GetPooledGameObject()
		{
			...
			for (var i = 0; i < _objectPool.PooledGameObjects.Count; i++)
		...
		protected virtual GameObject AddOneObjectToThePool()
		{
			...
			{
				Debug.LogWarning(
					"The " + gameObject.name + " ObjectPooler doesn't have any GameObjectToPool defined.", gameObject);
				return null;
			}
