...
namespace MoreMountains.Tools
{
	...
	public class ReorderableDrawer : PropertyDrawer
	{
		...
		public static MMReorderableList GetList(
			SerializedProperty property, MMReorderableAttributeAttribute attrib, int id)
		{
			...
			if (array != null && array.isArray)
			{
				if (!lists.TryGetValue(id, out list))
				{
					if (attrib != null)
					{
						...
						list = new MMReorderableList(
							array, attrib.add, attrib.remove, attrib.draggable, displayType, attrib.elementNameProperty,
