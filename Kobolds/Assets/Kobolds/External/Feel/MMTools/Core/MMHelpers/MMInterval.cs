...
namespace MoreMountains.Tools
{
	...
	public struct MMInterval<T> where T : struct, IComparable
	{
		...
		public MMInterval(
			T lowerBound, T upperBound, MMIntervalType lowerboundIntervalType = MMIntervalType.Inclusive,
		...
		{
			var lowerBoundCheck = LowerBoundIntervalType == MMIntervalType.Exclusive ?
				LowerBound.CompareTo(value) < 0 :
				LowerBound.CompareTo(value) <= 0;
			var upperBoundCheck = UpperBoundIntervalType == MMIntervalType.Exclusive ?
