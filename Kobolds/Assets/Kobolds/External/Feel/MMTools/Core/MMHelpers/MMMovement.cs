...
namespace MoreMountains.Tools
{
	...
	public static class MMMovement
	{
		...
		public static IEnumerator MoveFromTo(
			GameObject movingObject, Vector3 pointA, Vector3 pointB, float duration, AnimationCurve curve = null)
		{
			var journey = 0f;
			Vector3 newPosition;
		...
		public static IEnumerator AnimateScale(
			Transform targetTransform, Vector3 vector, float duration, AnimationCurve curveX, AnimationCurve curveY,
			AnimationCurve curveZ, float multiplier = 1f)
		{
		...
		public static IEnumerator AnimateRotation(
