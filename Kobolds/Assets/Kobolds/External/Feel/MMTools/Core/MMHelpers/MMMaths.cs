...
namespace MoreMountains.Tools
{
	...
	public static class MMMaths
	{
		...
		/// <returns></returns>
		private static float SpringVelocity(
			float currentValue, float targetValue, float velocity, float damping, float frequency, float deltaTime)
		{
			frequency = frequency * 2f * Mathf.PI;
			var f2 = frequency * frequency;
			var d2 = 2.0f * damping * frequency;
			var x = currentValue - targetValue;
			var acceleration = -f2 * x - d2 * velocity;
		...
		public static void Spring(
			ref float currentValue, float targetValue, ref float velocity, float damping, float frequency,
			float deltaTime)
		{
			...
			{
				var step = Mathf.Min(accumulator, fixedDeltaTime);
		...
		/// <param name="deltaTime">the delta time (usually Time.deltaTime or Time.unscaledDeltaTime)</param>
		public static void Spring(
			ref Vector2 currentValue, Vector2 targetValue, ref Vector2 velocity, float damping, float frequency,
			float deltaTime)
		{
			var fixedDeltaTime = 1.0f / 60.0f;
			var accumulator = deltaTime;
		...
		/// <param name="deltaTime">the delta time (usually Time.deltaTime or Time.unscaledDeltaTime)</param>
		public static void Spring(
			ref Vector3 currentValue, Vector3 targetValue, ref Vector3 velocity, float damping, float frequency,
			float deltaTime)
		{
			var fixedDeltaTime = 1.0f / 60.0f;
			var accumulator = deltaTime;
		...
		/// <param name="deltaTime">the delta time (usually Time.deltaTime or Time.unscaledDeltaTime)</param>
		public static void Spring(
			ref Vector4 currentValue, Vector4 targetValue, ref Vector4 velocity, float damping, float frequency,
			float deltaTime)
		{
			var fixedDeltaTime = 1.0f / 60.0f;
			var accumulator = deltaTime;
