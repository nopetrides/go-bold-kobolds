		...
		internal struct BakeBoxJob : IJob
		{
			...
			public void Execute()
			{
				...
				var bakeToShape = Math.GetBakeToShape(
					LocalToWorld, ShapeToWorld, ref center, ref orientation, BakeUniformScale);
...
#region Capsule
		...
		internal struct BakeCapsuleJob : IJob
		{
			...
			public void Execute()
			{
				...
				var bakeToShape = Math.GetBakeToShape(
					LocalToWorld, ShapeToWorld, ref center, ref orientation, BakeUniformScale, true);
				var scale = bakeToShape.DecomposeScale();
...
#region Sphere
		...
		private struct BakeSphereJob : IJob
		{
			...
			public void Execute()
			{
				...
				var bakeToShape = Math.GetPrimitiveBakeToShapeMatrix(
					LocalToWorld, ShapeToWorld, ref center, ref orientation, basisPriority, BakeUniformScale);
