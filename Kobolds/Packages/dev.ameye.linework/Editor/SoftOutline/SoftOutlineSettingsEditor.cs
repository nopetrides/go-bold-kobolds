		...
		public override void OnInspectorGUI()
		{
			...
			switch ((DilationMethod) dilationMethod.intValue)
			{
				case DilationMethod.Box:
					...
					if ((OutlineType) type.intValue == OutlineType.Hard)
						EditorGUILayout.PropertyField(gap, EditorUtils.CommonStyles.Gap);
					break;
			...
			if ((OutlineType) type.intValue == OutlineType.Hard)
			{
				...
				EditorGUILayout.HelpBox(
					"When using a 'Hard' outline, the color is shared between all outlines.", MessageType.Info);
			}
